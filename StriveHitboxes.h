...
class StriveHitboxes : public Mod
{
public:
	...
	StriveHitboxes()
	{
		ModName = "StriveHitboxes"; // Mod Name -- If Using BP ModActor, Should Be The Same Name As Your Pak
		ModVersion = "1.0.0"; // Mod Version
		ModDescription = "Strive hitbox viewer"; // Mod Description
		ModAuthors = "WistfulHopes"; // Mod Author
